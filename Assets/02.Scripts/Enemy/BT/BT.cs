...
public class BT : MonoBehaviour
{
    ...
    public virtual void MakeBT()
    {
        ...
        SequenceNode listen = new SequenceNode(new List<INode> {new ListenTargetNode() ,new LChaseNode() });
        ...
        root = new SelectorNode(new List<INode> { isDead, isDamaged, attackF, find, listen,new IdleNode() });
    }
